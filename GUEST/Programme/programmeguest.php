    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
       <ul>
          ...
          <li class="dropdown"><a class="nav-link scrollto active" href="../Programme/programmeguest.php"><span>Programme</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
			  ...
			  <div class="row">
				...
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
						...
						echo "<button ><a href='../../ACCOUNT/LOGIN/login.html'style='color:black;'>Register</a></button>";
