    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="../Programme/programmeguest.php"><span>Programme</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="../Programme/programmeguest.php#UTM">UTM</a></li>
              <li><a href="../Programme/programmeguest.php#COMSTAR">COMSTAR</a></li>
              <li><a href="../Programme/programmeguest.php#Public">Public</a></li>
            </ul>
          </li>
		  <li><a href="../../ACCOUNT/LOGIN/login.html">Login</a></li>
		  <li><a class="nav-link scrollto active" href="forumguest.php">Forum</a></li>
			  ...
			  <div class="col-lg-6">
				...
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
						...
						$title=$row["Title"];
						echo "<form action='../Forum/viewguestpost.php' method='post'>
