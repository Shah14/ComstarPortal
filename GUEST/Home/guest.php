    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
		  ...
		  <li><a href="../Forum/forumguest.php">Forum</a></li>
    ...
    <section id="services" class="services">
      <div class="container">
		...
		<div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
			  <a href="../Programme/programmeguest.php">
		...
		<div class="row">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
			  <a href="../Support/supportguest.php">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <span class="recommended-badge">First-Year Only</span>
              ...
              <div class="btn-wrap">
                <a href="../../ACCOUNT/LOGIN/login.html" class="btn-buy">Pay Now</a>
              </div>
            </div>
          </div>
