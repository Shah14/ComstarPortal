...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">COMSTAR UTMKL</a></h1>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item categories">
                <ul>
                  ...
                  <li><a href="#">Program <span>(12)</span></a></li>
                  <li><a href="#">Project <span>(5)</span></a></li>
                  <li><a href="#">Coding <span>(22)</span></a></li>
                  <li><a href="#">Design <span>(8)</span></a></li>
                  <li><a href="#">Intern <span>(14)</span></a></li>
                </ul>
