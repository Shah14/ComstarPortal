	  ...
	  <h1>Posts</h1>
            ...
            <div class="sidebar">
              ...
              <h3 class="sidebar-title">User Dashboard</h3>
				  ...
				  Enter Post Title <br>
				  <input class="text" placeholder="COMSTAR Event" required name="title" size="50"> <br><br>
				  Enter Post Description<br>
				  <textarea id="about" placeholder="COMSTAR Event Description" required name="about" rows="10" cols="50"></textarea> <br><br>
				  <input type="submit"value="Enter">
				  </form>
				  <br>
				  </div><br>
				  
				  <a href="../Forum/userpost.php"><button class="collapsible">  View My Post</button></a>
				...
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
						...
						$title=$row["Title"];
						echo "<form action='../Forum/viewpost.php' method='post'>
