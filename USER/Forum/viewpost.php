              ...
              <h3 class="sidebar-title">User Dashboard</h3>				 				  
				...
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
								...
								$title=$row["Title"];
								echo "<form action='../Forum/likepost.php' method='post'>
								<button name='title' type='submit' value='$title'>Like</button>
								</form>";
								echo "<form action='../Forum/reportpost.php' method='post'>
								<button name='title' type='submit' value='$title'>Report</button>
								</form>";
								echo "<br><form action='../Forum/replypost.php' method='post'>
								<input class='text' placeholder='Enter your reply' required name='reply' size='50'> <br>
								<button name='title' type='submit' value='$title'>Reply</button>
								</form>";
