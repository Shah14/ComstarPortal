	  ...
	  <h1>View My Posts</h1>
            ...
            <div class="sidebar">
              ...
              <h3 class="sidebar-title">User Dashboard</h3>
				  <button class="collapsible">Add Post</button>
				  <div class="content">
				  <br>
				  <form action="../Forum/addpost.php" method="post">
				  Enter Post Title <br>
				  <input class="text" placeholder="COMSTAR Announcement Title" required name="title"> <br><br>
				  Enter Post Description<br>
				  <textarea id="about" placeholder="COMSTAR Announcement Description" required name="about" rows="10" cols="50"></textarea> <br><br>
				  <input type="submit"value="Enter">
				  </form>
				  <br>
				  </div><br>
				  
				  <a href="../Forum/forum.php"><button class="collapsible">Back to Forum</button></a>
                ...
                <?php
				$result=mysqli_query($con,"SELECT * FROM `forum` WHERE Poster='$name' ORDER BY Date DESC");
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
