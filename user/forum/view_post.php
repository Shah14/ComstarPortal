								...
								echo '<div class="card">
									  ...
									  <div class="card-body p-0">
										<table class="table table-sm">
										  ...
										  <tbody>
											';	if($type=="Admin"){
													$result1=mysqli_query($con,"SELECT * FROM `admin` WHERE `Email`='$email'");
													...
													while($row = $result1->fetch_assoc()) {
														...
														if ($result2->num_rows > 0) {
															while($row = $result2->fetch_assoc()) {
																echo "<center><form action='../Forum/unlike_post_process.php' method='post'>
																<button style='width:112px;' class='btn btn-outline-danger bi bi-hand-thumbs-up' name='id' type='submit' value='".$id."'>Unlike</button>
																</form>";
															}
														}else{
														echo "<center><form action='../Forum/like_post_process.php' method='post'>
												   	    <button style='width:112px;' class='btn btn-outline-danger bi bi-hand-thumbs-up' name='id' type='submit' value='".$id."'>Like</button>
														</form>";
														}
														...
														if ($result3->num_rows > 0) {
															...
															echo '<button id="myBtn"style="width:112px;" class="btn btn-outline-danger bi bi-exclamation-triangle">Report</button>
																<div id="myModal" class="modal">
																  <div class="modal-content" style="text-align:left;">
																	<span style="text-align:right" class="close">&times;</span>
																	What is wrong with the discussion?
																	<form action="../Forum/report_post_process.php" method="post">
																	<input type="radio" id="reason" required name="reason" value="spam">
																	<label for="reason">It is a spam.</label><br>
																	<input type="radio" id="reason" required name="reason" value="controversional">
																	<label for="reason">It is a controversional topic.</label><br>
																	<input type="radio" id="html" required name="reason" value="misinformational">
																	<label for="reason">It is misinformational.</label><br>
																	<center>
																	<button style="width:112px;" class="btn btn-outline-danger bi bi-exclamation-triangle" name="id" type="submit" value="'.$id.'">Report</button>
																	</form>
																	</center>
																  </div>
												...
												$result1=mysqli_query($con,"SELECT * FROM `login` WHERE `Email`='$email'");
												if ($result1->num_rows > 0) {
													while($row = $result1->fetch_assoc()) {
														$image=$row["Image"];
														echo '<tr>
										  ...
										  <th></th>
										  <tr>';
										  $result1=mysqli_query($con,"SELECT * FROM `login` WHERE `Email`='$q'");
												if ($result1->num_rows > 0) {
													while($row = $result1->fetch_assoc()) {
														$image=$row["Image"];
														$name=$row["Full Name"];
										  ...
										  <td>';
											echo '<form action="../Forum/reply_post_process.php" class="form-horizontal" method="post" >
												  <div class="form-group row">
													<div class="col-sm-10">
													  <textarea class="form-control" required name="reply" rows="5" cols="60" placeholder="Enter your reply here"></textarea>
													</div>
												  </div>	
												 <div class="form-group row">
													<div class="offset-sm-2 col-sm-10">
													  <button type="submit" name="id"class="btn btn-danger" value="'.$id.'">Reply</button>
													</div>
												  </div>
												</form>
										  </td>
