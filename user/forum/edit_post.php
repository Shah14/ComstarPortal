            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#add" data-toggle="tab">Edit Post</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="add">
                    <form action="edit_post_process.php" class="form-horizontal" method="post" enctype='multipart/form-data'>
					<input type="hidden" class="form-control" required name="id" value="<?php echo $id;?>">
                      <div class="form-group row">
                        <label for="inputID" class="col-sm-2 col-form-label">Update Post Title</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" required name="title" value="<?php echo $title;?>"placeholder="COMSTAR Event">
                        </div>
                      </div>
					  <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Update Post Description</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" required name="about" rows="10" cols="50" placeholder="COMSTAR Event Description"><?php echo $desc;?></textarea>
                        </div>
                      </div>
					</div>	
					 <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                          <button type="submit" class="btn btn-danger"><i class='fas fa-pen'></i> Edit</button>
                        </div>
                      </div>
                    </form>
                  </div>
