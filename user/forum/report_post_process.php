...
$sql2="INSERT INTO `report`(`Post ID`,`User`,`Reason`,`Status`) VALUES('$_POST[id]','$q','$_POST[reason]','Report')";

if (!mysqli_query($con,$sql)){
}
if (!mysqli_query($con,$sql2)){
}header("Location: forum.php");
$_SESSION["Alert"] = "You have successfully reported a post!"; //for alert 
mysqli_close($con);
?>
<html>
