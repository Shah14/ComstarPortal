        ...
        <ul>
		 ...
		 <li class="dropdown"><a class="nav-link scrollto" href="../Profile/profile.php"><span>Profile</span> <i class="bi bi-chevron-down"></i></a>
		  ...
		  <style>
			...
			<li><button class="btn btn-outline-danger" data-toggle="button" aria-pressed="false" autocomplete="off" onclick="Function()"><i class="bi bi-moon"></i>Dark mode</button></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-12 entries">
            ...
            <article class="entry">
			  ...
			  <form action="../Support/add_support_process.php" class="form-horizontal" method="post">
