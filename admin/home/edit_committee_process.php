...
session_start();
$sql="UPDATE `committee` SET `Name`='$_POST[name]',`Role`='".substr($_POST["role"],2)."',`Session`='$_POST[session]',`Position`='".substr($_POST["role"],0,2)."',`Social 1`='$_POST[social1]',`Link 1`='$_POST[link1]',`Social 2`='$_POST[social2]',`Link 2`='$_POST[link2]',`Social 3`='$_POST[social3]',`Link 3`='$_POST[link3]'
