...
rename("../../COMSTAR Committee/MT BARU/".$_FILES["fileToUpload"]["name"],"../../COMSTAR Committee/MT BARU/".$title.".".$imageFileType); //press ctrl+f5 to hard refresh if image didnt update
$filename= $title.".".$imageFileType;
$sql="UPDATE `committee` SET `Picture`='$filename' WHERE ID='$_POST[id]'";
