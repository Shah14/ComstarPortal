...
<head>
  ...
  <title>Admin HomePage Edit | Dashboard</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
			  ...
			  <li class="nav-item">
                <a href="adminhomeedit.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit Homepage</p>
                </a>
              </li>
        ...
        <div class="row" >
          ...
          <!-- /.col -->
            ...
            <div class="card">
              ...
              <div class="card-body">			 
                    <form action="../Homepage/updatehomepage.php" class="form-horizontal" method="post">
                      <div class="form-group row">
                        <label for="inputID" class="col-sm-2 col-form-label">Description</label>
                        <div class="col-sm-10">
						  <textarea id="about" required name="about" rows="10" cols="65">
						<?php 
						$con = new mysqli("localhost","root","","comstar_portal");
