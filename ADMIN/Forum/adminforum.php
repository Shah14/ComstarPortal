        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
			  ...
			  <li class="nav-item">
                <a href="../Profile/adminprofile.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Profile</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../Verify/adminverify.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User Verification</p>
                </a>
              </li>
			  <li class="nav-item">
                <a href="../Programme/adminprogramme.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Programme</p>
                </a>
              </li>
			  <li class="nav-item">
                <a href="../Programme/adminattendance.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
			  ...
			  <li class="nav-item">
                <a href="../Support/admintechnical.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Technical Support</p>
                </a>
              </li>
			  <li class="nav-item">
                <a href="../Homepage/adminhomeedit.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit Homepage</p>
                </a>
              </li>
			  <li class="nav-item">
                <a href="adminforum.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Admin Forum</p>
                </a>
              </li>
          ...
          <div class="col-md-7">
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Forum Posts</h3>
              ...
              <!-- /.card-header -->
				...
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
						...
						$title=$row["Title"];
						echo "<form action='../Forum/viewadminpost.php' method='post'>
						<button name='title' type='submit' value='$title'>View</button>
						</form>";
						echo "</div>";
						}
					}else {
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="add">
                    <form action="../Programme/addprogramme.php" class="form-horizontal" method="post">
				   ...
				   <div class="tab-pane" id="update">
                    <form action="../Programme/updateprogramme.php" class="form-horizontal" method="post">
                      <div class="form-group row">
                        <label for="inputID" class="col-sm-2 col-form-label">Programme ID</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" required name="id" placeholder="Example : PDWC1234">
                  ...
                  <!-- /.tab-pane -->
				   <div class="tab-pane" id="delete">
                    <form action="../Programme/deleteprogramme.php" class="form-horizontal" method="post">
                      <div class="form-group row">
                        <label for="inputID" class="col-sm-2 col-form-label">Programme ID</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" required name="id" placeholder="Example : PDWC1234">
