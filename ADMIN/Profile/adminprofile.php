        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
			  ...
			  <li class="nav-item">
                <a href="../Profile/adminprofile.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Profile</p>
                </a>
              </li>
...
?>
                ...
                <a href="../../ACCOUNT/LOGIN/logout.php" class="btn btn-primary btn-block"><b>Log Out</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="update">
                    <form action="../Profile/updateadmin.php" class="form-horizontal" method="post">
				  ...
				  <div class="tab-pane" id="image">
                    <form action="../Profile/adminpicture.php"class="form-horizontal" method="post" enctype="multipart/form-data">
                      <div class="form-group row">
				  ...
				  <div class="tab-pane" id="change">
                    <form action="../Profile/changepassword.php"class="form-horizontal" method="post" onsubmit="return verifyPassword()">
                      <div class="form-group row">
